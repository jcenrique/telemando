<div class="">
    @if ($alarmas!= null && $alarmas->count() != 0  )
        @foreach ($alarmas as $key => $value)
            ...
            <div class="grid grid-cols-3 font-mono  rounded-lg  border-gray-200 border  mb-1">
                ...
                <div id="accion{{$value->id }}" class="col-span-3  bg-gray-100  bg-clip-padding hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 mb-8">
           {{$alarmas->links('vendor.pagination.tailwind')}} 
      </div>
    @else
