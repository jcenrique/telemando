...
<div class="bg-white shadow-sm rounded mb-3">
    @forelse($results as $item)
        ...
        <a href="{{$item->url()}}" class="block py-2 px-3 dropdown-item border" style="font-size: 0.85em;">
            ...
            <span class="clear">
                <span class="text-ellipsis text-success">{{$item->title()}}</span>
                <small class=" clear text-ellipsis mb-1 text-info">
                    {{$item->subTitle()}} 
                </small>
                <div class="text-muted clear text-ellipsis">
